"""
refer: https://github.com/sharebook-kr/pykiwoom/blob/bafc3fa96d135e282cc725d04d97d6071124cbbd/pykiwoom/update.py
"""
import os
import sys
...
def click_button(btn_hwnd):
    win32api.SendMessage(btn_hwnd, win32con.WM_LBUTTONDOWN, 0, 0)
    win32api.Sleep(100)
    win32api.SendMessage(btn_hwnd, win32con.WM_LBUTTONUP, 0, 0)
    win32api.Sleep(300)
